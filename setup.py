...
setup(
    ...
    description='Tool for image segmentation and colorimetric analysis.',
    ...
    install_requires=[
        'groundingdino-py',"segment-anything-py","opencv-python"
    ],
    setup_requires=['groundingdino-py',"segment-anything-py","opencv-python"],
    tests_require=[
        'pytest',
        'pytest-cov',
        'pytest-html',
